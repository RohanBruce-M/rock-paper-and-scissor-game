...
while True:
    ...
    if user_choice == "r":
        if comp_choice == "r":
            ...
            print("You chose rock .The computer chose paper, yah! I am win")
            comp_wins +=1
        elif comp_choice == "s":
        ...
        if comp_choice == "r":
            ...
            print("You chose paper .The computer chose scissors, yah! Iam win")
            comp_wins +=1

            
    elif user_choice == "s":
        if comp_choice == "r":
            print("You chose scissors .The computer chose rock, yah! Iam win")
            comp_wins +=1
        elif comp_choice == "p":
